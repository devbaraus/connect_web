				...
				<div class="flex-shrink max-w-full w-full lg:w-2/5 px-3 lg:pr-16">
					...
					<ul class="space-x-3 mt-6 mb-6 Lg:mb-0">
						...
						<li class="inline-block">
							<a target="_blank" class="hover:text-gray-800" rel="noopener noreferrer" href="/">
				...
				<div class="flex-shrink max-w-full w-full lg:w-3/5 px-3">
					<div class="flex flex-wrap flex-row">
						<div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
							...
							<ul>
								<li class="py-1 hover:text-gray-900"><a href="/">Documentation</a></li>
								<li class="py-1 hover:text-gray-900"><a href="/">Components</a></li>
								<li class="py-1 hover:text-gray-900"><a href="/">Credits</a></li>
								<li class="py-1 hover:text-gray-900"><a href="/">Changelog</a></li>
							</ul>
						</div>
						<div class="flex-shrink max-w-full w-1/2 md:w-1/3 mb-6 lg:mb-0">
